...
class EmotionButton extends StatelessWidget {
  _buildselectedReaction(EmotionState state) {
    if (state.userStatus == EmotionInteractionStatus.reactedWithLike) {
      return Reaction(
          id: 1,
    ...
    if (state.userStatus == EmotionInteractionStatus.reactedWithLove) {
      return Reaction(
          id: 2,
    ...
    if (state.userStatus == EmotionInteractionStatus.reactedWithWow) {
      return Reaction(
          id: 3,
    ...
    if (state.userStatus == EmotionInteractionStatus.reactedWithAngry) {
      return Reaction(
          id: 4,
          ...
          return Positioned(
            ...
            child: FlutterReactionButtonCheck(
              onReactionChanged: (reaction, isChecked) {
                context
                    .read<EmotionBloc>()
                    .add(EmotionReactRequested(reaction.id));
              },
              reactions: <Reaction>[
                Reaction(
                  id: 1,
