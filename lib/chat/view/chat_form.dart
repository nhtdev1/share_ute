...
class ChatForm extends StatelessWidget {
  ...
  Widget buildMessages(BuildContext chatViewContext) {
    return Flexible(
      ...
      itemCount: ChatForm.messages.length,
      itemBuilder: (context, index) {
        final topContent = index == 0 ? "" : ChatForm.messages[index - 1];
        final middleContent = ChatForm.messages[index];
        final bottomContent = index == ChatForm.messages.length - 1
            ? ""
            : ChatForm.messages[index + 1];
