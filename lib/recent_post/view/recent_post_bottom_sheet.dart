...
class RecentPostBottomSheet extends StatelessWidget {
  RecentPostBottomSheet({this.post});
    ...
    return Column(
      ...
      children: [
        ...
        ListTile(
          ...
          title: Text('Xóa khỏi gần đây'),
          onTap: () {
            context.read<PostNotificationCubit>().removeRecentPost(post);
            Navigator.pop(context);
          },
        ),
        ListTile(
